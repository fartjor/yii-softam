...
class Tipo_processoController extends Controller
{
	/**
	...
	public function actionNovo()
	{
		...
		if(isset($_POST['Tipo_processo']))
		{
			...
			$model->tpr_data_ingresso = date('Y-m-d H:i:s');
			if($model->save())
	...
	{
		$model=new Tipo_processo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tipo_processo']))
			$model->attributes=$_GET['Tipo_processo'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Tipo_processo::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-processo-form')
		{
