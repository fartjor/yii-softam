...
insert  into `tipo_processo`(`tpr_id`,`tpr_nome`,`tpr_area_atuacao`,`tpr_data_ingresso`,`tpr_obs`,`tpr_data_modificacao`,`tpr_situacao`) values (1,'Trabalhista','Trabalhista','2011-05-30 00:00:00','Causas de trabalho',NULL,'A'),(3,'Cívil','Cívil','2011-06-08 00:00:00','',NULL,'A'),(6,'Pensão Alimentícia','Cívil','2011-06-08 00:00:00','',NULL,'A');
