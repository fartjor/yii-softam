...
MySQL - 5.1.30-community : Database - gescon
*********************************************************************
*/
...
insert  into `cargo`(`car_id`,`car_nome`,`car_data_ingresso`,`car_ativo`,`car_obs`,`car_data_modificacao`) values (1,'ANALISTA DE SISTEMAS SENIOR','2011-05-26','I','ELE FAZ TODA A ANALISE DE SISTEMAS',NULL);
...
CREATE TABLE `funcionario` (
  ...
  CONSTRAINT `fk_Funcionario_Empresa1` FOREIGN KEY (`emp_id`) REFERENCES `empresa` (`emp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

/*Data for the table `funcionario` */

insert  into `funcionario`(`fun_id`,`fun_cpf`,`fun_data_cadastro`,`fun_numero_funcionario`,`fun_nome`,`fun_sexo`,`fun_estado_civil`,`fun_funcao`,`fun_email`,`fun_obs`,`fun_data_modificacao`,`fun_data_desligamento`,`car_id`,`emp_id`,`fun_fone1`,`fun_fone2`,`fun_endereco`,`fun_cidade`,`fun_uf`,`fun_cep`,`fun_estado`) values (4,'524.814.172-91','2011-05-30',45645646,'Jair Rebello','M','S','ANALISTA DE SISTEMAS PLENO','jair.rebello@pmm.am.gov.br',NULL,NULL,NULL,1,1,'(92)3638-9774','(92)3638-9774','Meu endereço','Manaus','AM','52484-848',''),(5,'266.714.023-02','2011-05-30',2147483647,'Teste','M','S','ANALISTA DE SISTEMAS PLENO','jair.rebello@pmm.am.gov.br',NULL,NULL,NULL,1,2,'9236389774','9236389774','Meu endereço','Manaus','AM','69082-452','');
