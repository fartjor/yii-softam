...
INSERT INTO `boleto` (`bol_codigo`,`bol_valor`,`bol_vencimento`,`bol_transacao`,`bol_situacao`,`pro_id`,`bol_tipo`) VALUES 
 (1,'400.00','2011-06-21','','Boleto Gerado',1,'E'),
 (2,'7555.55','2011-06-21','','Boleto Gerado',5,'E'),
 (3,'400.00','2011-07-15','','Boleto Gerado',1,'E'),
...
INSERT INTO `cliente` (`cli_id`,`cli_cpf`,`cli_data_cadastro`,`cli_nome`,`cli_sexo`,`cli_estado_civil`,`cli_profissao`,`cli_email`,`cli_conhecimento`,`cli_obs`,`cli_data_modificacao`,`cli_fone1`,`cli_fone2`,`cli_endereco`,`cli_cidade`,`cli_uf`,`cli_cep`,`cli_situacao`,`cli_bairro`,`fil_id`) VALUES 
 (1,'524.814.172-91','2011-05-30 00:00:00','Jair Rebello','M','S','Analista de Sistemas','fsdfsfs@hotmail.com','muito','Este é um cliente em potencial','2011-07-18 18:50:38','(89)4984-8948','(89)4894-8949','Rua tal','Manaus','AM','51565-654','A','Ouro Verde',1),
 (2,'886.499.102-62','2011-07-06 18:36:58','Cliente 1','M','C','Analista de Negócios','','','545454',NULL,'(89)8948-9489','','Rua teste','Manaus','AM','69082-541','A','Teste',1);
...
INSERT INTO `tipo_processo` (`tpr_id`,`tpr_nome`,`tpr_area_atuacao`,`tpr_data_ingresso`,`tpr_obs`,`tpr_data_modificacao`,`tpr_situacao`) VALUES 
 (1,'Trabalhista','Trabalhista','2011-05-30 00:00:00','Causas de trabalho','2011-06-09 18:09:47','I'),
...
INSERT INTO `usuario` (`usu_id`,`usu_nome`,`usu_senha`,`usu_email`,`usu_login`,`fun_id`) VALUES 
 (1,'Jair Rebello de Souza Junior','33f4d618f86939c2e016d8f7194c0a87','jair.rebello@hotmail.com','jair.rebello',2);
